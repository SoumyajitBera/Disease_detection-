...
MODEL_PATH = BASE_DIR / "outputs_rice" / "rice_cnn_best.keras"
CLASS_MAP_JSON = BASE_DIR / "outputs_rice" / "class_indices.json"
IMG_SIZE = (224, 224)
FALLBACK_CLASSES = ["Bacterialblight", "Brownspot", "Leafsmut"]
...
log = logging.getLogger("rice-api")

# -------------------------------------
# APP SETUP
# -------------------------------------
app = FastAPI(title="Rice Disease Classifier", version="2.0")
